...
import { Program, Accounts, IdlTypes, BN, IdlAccounts, ProgramAccount } from '@coral-xyz/anchor';
...
type SwapQuoteRemainingCurveParam = {
    virtualPool: VirtualPool;
    config: PoolConfig;
    currentPoint: BN;
};
 ...
 */
declare function validateFeeScheduler(numberOfPeriod: number, periodFrequency: BN$1, reductionFactor: BN$1, cliffFeeNumerator: BN$1): boolean;
/**
 ...
 * @returns Swap result
 */
declare function getSwapResult(poolState: VirtualPool, configState: PoolConfig, amountIn: BN$1, feeMode: FeeMode, tradeDirection: TradeDirection, currentPoint: BN$1): SwapResult;
/**
 ...
 */
declare function swapQuote(virtualPool: VirtualPool, config: PoolConfig, swapBaseForQuote: boolean, amountIn: BN$1, slippageBps: number, hasReferral: boolean, currentPoint: BN$1): SwapQuoteResult;
/**
 ...
 * @returns Swap result
 */
declare function getSwapResultFromExactInput(virtualPool: VirtualPool, config: PoolConfig, amountIn: BN$1, feeMode: FeeMode, tradeDirection: TradeDirection, currentPoint: BN$1): SwapResult2;
/**
 ...
 * @returns Swap result
 */
declare function getSwapResultFromPartialInput(virtualPool: VirtualPool, config: PoolConfig, amountIn: BN$1, feeMode: FeeMode, tradeDirection: TradeDirection, currentPoint: BN$1): SwapResult2;
/**
 ...
 * @returns Swap result
 */
declare function getSwapResultFromExactOutput(virtualPool: VirtualPool, config: PoolConfig, amountOut: BN$1, feeMode: FeeMode, tradeDirection: TradeDirection, currentPoint: BN$1): SwapResult2;
/**
 ...
 * @returns Swap quote result
 */
declare function swapQuoteExactIn(virtualPool: VirtualPool, config: PoolConfig, swapBaseForQuote: boolean, amountIn: BN$1, slippageBps: number, hasReferral: boolean, currentPoint: BN$1): SwapQuote2Result;
/**
 ...
 * @returns Swap quote result
 */
declare function swapQuotePartialFill(virtualPool: VirtualPool, config: PoolConfig, swapBaseForQuote: boolean, amountIn: BN$1, slippageBps: number, hasReferral: boolean, currentPoint: BN$1): SwapQuote2Result;
/**
 ...
 */
declare function swapQuoteExactOut(virtualPool: VirtualPool, config: PoolConfig, swapBaseForQuote: boolean, outAmount: BN$1, slippageBps: number, hasReferral: boolean, currentPoint: BN$1): SwapQuote2Result;
